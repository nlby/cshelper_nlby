...
function getUserFavorite(id) {
    $.ajax({
        url: 'http://123.56.15.54:8080/anbbs/favorite/user/' + id,
        dataType: 'json',
        async: true,
        type: 'get',
...
function getStar(starId) {
    select = starId;
    $.ajax({
        url: 'http://123.56.15.54:8080/anbbs/post/favorite/' + starId + '/page/1/id',
        dataType: 'json',
        async: true,
        type: 'get',
        success: function (result) {
...
function addFavorite() {
    $.ajax({
        url: 'http://123.56.15.54:8080/anbbs/favorite',
        dataType: 'json',
        async: true,
        type: 'post',
        data: {
