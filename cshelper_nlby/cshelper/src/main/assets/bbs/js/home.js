...
function toggle() {
    ...
    $lis.click(function () {
        ...
        if(type === "post"){
            ...
            $.ajax({
                url: "http://123.56.15.54:8080/anbbs/post/question/" + uid + "/page/1/id",
                method: "get",
                dataType: "json",
            ...
            $(".item-list").empty();
            $.ajax({
                url: "http://123.56.15.54:8080/anbbs/comment/user/id/" + uid,
                method: "get",
                dataType: "json",
                success: function (res) {
                    if(res.status){
...
function basicInfo() {
    ...
    $.ajax({
        url: "http://123.56.15.54:8080/anbbs/user/id/" + uid,
        method: "get",
        dataType: "json",
        success: function (res) {
            if(res.status){
    ...
    //获得tabs的三个信息
    $.ajax({
        url: "http://123.56.15.54:8080/anbbs/post/number/id/" + uid,
        method: "get",
        dataType: "json",
        success: function (res) {
            if(res.status){
...
function getPosts() {
    $.ajax({
        url: "http://123.56.15.54:8080/anbbs/post/user/" + uid + "/page/1/id",
        method: "get",
        dataType: "json",
        success: function (res) {
            if(res.status){
