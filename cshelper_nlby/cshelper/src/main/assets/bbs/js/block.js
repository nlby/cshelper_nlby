...
function getBlockInfo() {
    ...
    $.ajax({
        url: "http://123.56.15.54:8080/anbbs/block/id/" + id,
        method: "get",
        dataType: "json",
        success: function (res) {
            if(res.status){
                ...
                //加载版主信息
                $.ajax({
                    url: "http://123.56.15.54:8080/anbbs/user/id/" + res.data.adminUserId,
                    method: "get",
                    dataType: "json",
                    success: function (res) {
                        if(res.status){
...
function getPosts(id, sortType) {
    ...
    $.ajax({
        url: "http://123.56.15.54:8080/anbbs/post/block/" + id + "/page/1/"+ sortType,
        method: "get",
        dataType: "json",
        success: function (res) {
