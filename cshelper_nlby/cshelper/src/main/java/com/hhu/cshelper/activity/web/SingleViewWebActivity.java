...
/** 单页卡Web界面基类
 * @name  SingleViewWebActivity
 * @description  单页卡Web界面基类
 * @author  nlby
 * @date  2020/4/29
 */
public class SingleViewWebActivity extends BaseWebActivity {
...
/**       页面主要内容配置    start    **/
    ...
    protected void initWeb(String url) {
        ...
        configWebView(wv, url, new SingleViewWebActivity.CustomWebViewClient());
