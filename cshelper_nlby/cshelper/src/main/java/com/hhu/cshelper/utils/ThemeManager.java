...
public class ThemeManager {
    ...
    private String[] mThemes = {"酷炫黑", "原谅绿",  "少女红", "胖次蓝", "基佬紫", "活力橙", "大地棕"};

    private static ThemeManager instance;

    public static ThemeManager getInstance() {  // 获取主题管理器单例
        if (instance == null) {
    ...
    public void setTheme(Activity context, String theme){
        ...
        if(curTheme != null && curTheme.equals(theme) && !SharedPUtils.isFirstStart(context)){
            return;
        }
        ...
        intent.putExtra("com.example.app_web_note_mvp.IS_UPDATE_THEME", true);
